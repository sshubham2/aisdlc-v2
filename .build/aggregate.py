# -*- coding: utf-8 -*-
"""Aggregate the 26 staged skill manifests into per-skill skill.json + a global skill-graph.json.
...
VALID_AGENTS = {"critique","critic-calibrate","critique-review","diagnose-narrator","field-recon","code-review"}
...
assert len(manifests) == 26, f"expected 26 skills, got {len(manifests)}"
...
graph = {
    "generated_from": "temp/skills/*/SKILL.md (AI SDLC v1, 26 skills)",
